...
pytest: error: the following arguments are required: param2""",
    ...
    Case(["p1", "p2"], out="p1 p2",),  # pass both required
]


def all_type_func(param1: int, param2: str, kw1=None, kw2=False, *args, **kwargs):
    """Example function with types documented in the docstring.

    :param param1: The first parameter.
    :param param2: The second parameter.
    """
    _reprint(param1, param2, kw1, kw2, args, kwargs)
